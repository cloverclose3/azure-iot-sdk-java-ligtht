...
public class MqttConnection
{
    ...
    private static final int KEEP_ALIVE_INTERVAL = 30; // 230
     ...
     */
    MqttConnection(String serverURI, String clientId, String userName, String password, SSLContext sslContext) throws TransportException, IllegalArgumentException, UnknownHostException
    {
        if (serverURI == null || clientId == null || userName == null)
        {
     ...
     */
    private void updateConnectionOptions(String userName, String userPassword, SSLContext iotHubSSLContext) throws UnknownHostException
    {
