...
public interface IotHubTransportConnection
{
     ...
     */
    void open(DeviceClientConfig deviceClientConfigs, ScheduledExecutorService scheduledExecutorService) throws TransportException;
     ...
     */
    boolean sendMessageResult(Message message) throws TransportException;
